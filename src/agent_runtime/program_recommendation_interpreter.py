...
10. 即使关键词规则已经识别出专业方向，也要继续提取对推荐有影响的背景：本科院校、
   已有专业、想离开当前就业环境的原因、目标国家或地区、目标岗位。优先把这些用户原话
   放进 evidence_phrases，并在 interpretation_summary 中说明它们如何影响方向衔接和
   下一步核验。不要把“国内太卷”改写成客观就业结论，只能表述为用户希望换一个发展环境。
"""
